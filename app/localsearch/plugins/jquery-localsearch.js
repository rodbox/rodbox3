...
(function($) {
    $.fn.localsearch = function(options) {
        ...
        $(document).on("keyup", this.selector, function(e) {
            ...
            if(e.keyCode == "38"|| e.keyCode == "40" || e.keyCode == "27" || e.keyCode == "13") {return false;}
        ...
        function autoFocus(sens){
            ...
            var elemFocusAvailable = param.target.find(".search-show");
            ...
            if(sens == "")
                elemFocus = elemFocusAvailable.first();
            ...
            var index = param.target.find(".search-show").index();
console.log(index);
